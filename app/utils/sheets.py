...
def sync_passed_applicant(app_record, user, passed=True):
    ...
    try:
        row = [
            ...
            app_record.country or "",
            app_record.city or "",
            app_record.campus_location or "",
            app_record.field_of_study or "",
            app_record.referral_code or "",
            app_record.referral_source or "",
            app_record.previous_student or "",
            app_record.previous_course or "",
            app_record.previous_cohort or "",
            app_record.current_status or "",
            app_record.profession or "",
            app_record.institution or "",
            "TRUE" if app_record.can_commit else "FALSE",
